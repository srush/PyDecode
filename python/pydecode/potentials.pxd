...
# cdef class _RealPotentials(_Potentials):
#     cdef CHypergraphRealPotentials *thisptr
#     # cdef HypergraphMap projection

#     cdef init(self, CHypergraphRealPotentials *ptr)
#               # HypergraphMap projection)
...
# cdef class _LogPotentials(_Potentials):
#     cdef CHypergraphLogPotentials *thisptr
#     # cdef HypergraphMap projection

#     cdef init(self, CHypergraphLogPotentials *ptr)
#               # HypergraphMap projection)
...
# cdef class _BooleanPotentials(_Potentials):
#     cdef CHypergraphBooleanPotentials *thisptr
#     # cdef HypergraphMap projection

#     cdef init(self, CHypergraphBooleanPotentials *ptr)
#               # HypergraphMap projection)
